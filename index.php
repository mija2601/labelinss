...
------------------------- */
$dosen_list = [
  ['nama' => 'Prof. Dr. Ir. Bidayatul Armynah, M.T', 'jab' => 'Pengampu'],
  ['nama' => 'Prof. Dr. Arifin, M.T', 'jab' => 'Pembimbing'],
  ['nama' => 'Prof. Dr. Bualkar Abdullah, M.Eng.Sc.', 'jab' => 'Pengampu'],
  ['nama' => 'Ida Laila, S.Si., M.Si', 'jab' => 'Pengampu']
];
...
if ($page == "home") {
    ...
    <div class='card'>
        ...
        <p>Website ini dibuat untuk menjelaskan bagaimana mahasiswa semester 5 yang mengambil peminatan Elektronika & Instrumentasi</p>
    </div>
    ";
}
...
elseif ($page == "lab") {
    echo "
    <div class='card'>
        <h2>Mahasiswa semester 5 Laboratorium Elektronika & Instrumentasi</h2>
        <p>Pada semester 5, mahasiswa peminatan Elektronika dan Instrumentasi (ELINS) mulai memasuki tahap praktik yang lebih terarah dan teknis. Fokus pembelajaran berada pada penguasaan mikrokontroler, sistem sensor, mikroprosesor, serta aplikasi instrumentasi dalam berbagai pengukuran fisis. Mahasiswa tidak hanya mempelajari teori, tetapi aktif melakukan eksperimen, merakit rangkaian, menganalisis sinyal, serta membuat proyek terapan</p>
    </div>";
}
